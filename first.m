...
for h = 1:54
  ...
  all_C(:,:,3,e)=m;
  %%标签
  if strcmp(cell2mat(TXT5(h,4)),'happiness')==1
     all_label(e,:) = 'positive';
  elseif strcmp(cell2mat(TXT5(h,4)),'others')==1
     all_label(e,:) = 'Other   ';
  elseif strcmp(cell2mat(TXT5(h,4)),'surprise')==1
     all_label(e,:) = 'surprise'; 
  else
     all_label(e,:) = 'negative';
  end
...
i=1;l = 1;num = 1;acu = zeros(1,101);
while i<= 709
    m = 1; n=1;
    train_label = strings(709-G(l),1); test_label = strings(G(l),1);train_C = zeros(28,28,3,709-G(l));test_C = zeros(28,28,3,G(l));
