...
i=1;l = 1;num = 1;acu = zeros(1,709);
while i<= 709
    train_label = strings(708,1); test_label = strings(1,1);train_C = zeros(28,28,3,708);test_C = zeros(28,28,3,1);
    m = 1;
    for k = 1:i-1
